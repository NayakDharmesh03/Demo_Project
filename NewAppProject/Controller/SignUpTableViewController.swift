...
//MARK: - for textfiels down Arrow
//extension SignUpTableViewController
//{
//
//    func coutrySetArroTextfield(){
//        // Create a button with a down arrow system image
//        let button = UIButton(type: .system)
//        button.setImage(UIImage(systemName: "DownArrow"), for: .normal)
...
//
//        // Set the button as the text field's right view
//        countryTF.rightView = button
//        countryTF.rightViewMode = .always
//    }
//    func stateSetArroTextfield(){
//        // Create a button with a down arrow system image
//        let button = UIButton(type: .system)
//        button.setImage(UIImage(systemName: "DownArrow"), for: .normal)
//        button.addTarget(self, action: #selector(downArrowTapped), for: .touchUpInside)
...
//
//        // Set the button as the text field's right view
//        stateTF.rightView = button
//        stateTF.rightViewMode = .always
//    }
//    func citySetArroTextfield(){
//        // Create a button with a down arrow system image
//        let button = UIButton(type: .system)
//        button.setImage(UIImage(systemName: "DownArrow"), for: .normal)
//        button.addTarget(self, action: #selector(downArrowTapped), for: .touchUpInside)
...
//
//        // Set the button as the text field's right view
//        cityTF.rightView = button
//        cityTF.rightViewMode = .always
//    }
